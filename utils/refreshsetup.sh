...
then
	$(sleep 1s)
    xrandr --output eDP --mode 1920x1080 --pos 4520x0 --rotate normal --output HDMI-A-0 --mode 1920x1080 --pos 0x0 --rotate left --output DisplayPort-0 --primary --mode 3440x1440 --pos 1080x0 --rotate normal
